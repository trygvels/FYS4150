...
plt.subplot(211)
plt.hist(E[10000:],2,color=tableau20[2],weights=weights)#,range=[-2.0, -1.8])
...
weights = np.ones_like(Es[10000:])/len(Es[10000:])
plt.hist(Es[10000:],10,color=tableau20[2],weights=weights)#,range=[-1.27, -1.21])
