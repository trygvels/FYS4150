...
T1,E1,Cv1,M1,X1,Mabs1= np.loadtxt("data/40_2_24_0.05_1e6_c60.dat",usecols=(0,1,2,3,4,5), unpack=True)

T2,E2,Cv2,M2,X2,Mabs2 = np.loadtxt("data/60_2_24_0.05_1e6_c60.dat",usecols=(0,1,2,3,4,5), unpack=True)

T3,E3,Cv3,M3,X3,Mabs3 = np.loadtxt("data/100_2_24_0.05_1e6_c60.dat",usecols=(0,1,2,3,4,5), unpack=True)

T4,E4,Cv4,M4,X4,Mabs4 = np.loadtxt("data/140_2_24_0.05_1e6_c60.dat",usecols=(0,1,2,3,4,5), unpack=True)
...
plt.title('Expectiation values for L=40,60,100 and 140')
...
plt.plot(T3, X3,color=tableau20[6],label='L=100')
plt.plot(T4, X4,color=tableau20[8],label='L=140')
# Sjekk plott. Gaar fra 0 til 3500, 500 av gangen. 
# Gang med antall kjerner (32 i dette eksempelet).
#plt.xticks(np.arange(0,len(T),2500),np.arange(0,len(T)*c,2500*c))
...
fig.savefig('EofT4060.pdf', bbox_inches='tight',pad_inches=0.106)
plt.show()
